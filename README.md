...
### 4. [FastAPI_Course](https://github.com/kassian006/FastAPI_Course)
<div>
FastAPI_Course — это веб-платформа для онлайн-обучения, разработанная с использованием FastAPI, SQLAlchemy, Redis и Celery. Сайт предоставляет возможность пользователям регистрироваться, проходить курсы, сдавать экзамены и получать сертификаты.
</div>
